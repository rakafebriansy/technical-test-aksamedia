...
const LoginPage = ({  }) => {
    ...
    return (
        <div className="flex justify-center items-center w-full h-screen">
            <div className="w-[30rem] bg-white border border-gray-300 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
                <div className="p-4 sm:p-7">
                    ...
                    <div className="mt-5">
                        <form>
                            ...
                            <div>
                                <label for="username" className="block text-sm mb-2 dark:text-white">Username</label>
