...
const AddEmployeePage = ({  }) => {
  ...
  const addEmployee = async () => {
    try {
      ...
      await EmployeeService.store(formData);
  ...
  useEffect(() => {
    ...
    if (!image) {
      newErrorBags.image.push('Gambar harus diisi.');
    }
      ...
      <div className="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
        ...
        <div>
          <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
            ...
            <div className="sm:col-span-9">
              <select id="division" value={divisionId} onChange={(e) => setDivisionId(e.target.value)} className="py-3 px-4 pe-9 block w-full border-gray-300 border rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
